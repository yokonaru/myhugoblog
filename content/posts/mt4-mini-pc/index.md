...
\[
8\text{W} \times 24\text{時間} = 192\text{Wh} = 0.192\text{kWh}
\]
...
\[
0.192\text{kWh} \times 28.5\text{円} = 5.472\text{円}
\]
...
\[
  5.472\text{円} \times 20\text{日} = 109.44\text{円}
  \]
...
\[
  5.472\text{円} \times 31\text{日} = 169.632\text{円}
  \]
...
\[
0.19\text{kWh} \times 28.5\text{円} = 5.415\text{円}
\]
